...
namespace Rpc\Greek\Slugs;

/**
 * A slug (pretty URL) generator, which supports Greek UTF-8 characters
 * https://github.com/stathisg/greek-slug-generator/blob/master/GreekSlugGenerator.php
 *
...
class GreekSlugGenerator
{
    ...
    private function convert_character($char)
    {
        ...
        if ($char === ' ' || $char === ':' || $char === '–' || $char === '_' || $char === '/' || $char === '\\') {
            return '-';
        } elseif (in_array ( $char, $allowed_characters )) {
            return strtolower ( $char );
        } elseif ($char == 'Α' || $char == 'α' || $char == 'Ά' || $char == 'ά') {
            return 'a';
        } elseif ($char == 'Β' || $char == 'β') {
            return 'b';
        } elseif ($char == 'Γ' || $char == 'γ') {
            return 'g';
        } elseif ($char == 'Δ' || $char == 'δ') {
            return 'd';
        } elseif ($char == 'Ε' || $char == 'ε' || $char == 'Έ' || $char == 'έ') {
            return 'e';
        } elseif ($char == 'Ζ' || $char == 'ζ') {
            return 'z';
        } elseif ($char == 'Η' || $char == 'η' || $char == 'Ή' || $char == 'ή') {
            return 'h';
        } elseif ($char == 'Θ' || $char == 'θ') {
            return 'th';
        } elseif ($char == 'Ι' || $char == 'ι' || $char == 'Ί' || $char == 'ί' || $char == 'ϊ' || $char == 'ΐ') {
            return 'i';
        } elseif ($char == 'Κ' || $char == 'κ') {
            return 'k';
        } elseif ($char == 'Λ' || $char == 'λ') {
            return 'l';
        } elseif ($char == 'Μ' || $char == 'μ') {
            return 'm';
        } elseif ($char == 'Ν' || $char == 'ν') {
            return 'n';
        } elseif ($char == 'Ξ' || $char == 'ξ') {
            return 'ks';
        } elseif ($char == 'Ο' || $char == 'ο' || $char == 'Ό' || $char == 'ό') {
            return 'o';
        } elseif ($char == 'Π' || $char == 'π') {
            return 'p';
        } elseif ($char == 'Ρ' || $char == 'ρ') {
            return 'r';
        } elseif ($char == 'Σ' || $char == 'σ' || $char == 'ς') {
            return 's';
        } elseif ($char == 'Τ' || $char == 'τ') {
            return 't';
        } elseif ($char == 'Υ' || $char == 'υ' || $char == 'Ύ' || $char == 'ύ' || $char == 'ϋ') {
            return 'y';
        } elseif ($char == 'Φ' || $char == 'φ') {
            return 'f';
        } elseif ($char == 'Χ' || $char == 'χ') {
            return 'x';
        } elseif ($char == 'Ψ' || $char == 'ψ') {
            return 'ps';
        } elseif ($char == 'Ω' || $char == 'ω' || $char == 'Ώ' || $char == 'ώ') {
            return 'w';
        } else {
            return '';
        }
