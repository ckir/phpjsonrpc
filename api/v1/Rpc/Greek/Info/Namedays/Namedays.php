...
namespace Rpc\Greek\Info\Namedays;
...
class Namedays
{
    ...
    public function getNamedays()
    {
        try {
            ...
            $cachedresponse = new \Rpc\Util\Cache\Cache ();
            ...
            try {
                ...
                throw new \Zend\Json\Exception\RuntimeException ( "Data unavailable:" . $e->getMessage (), \Zend\Json\Server\Error::ERROR_INTERNAL );
            }
            ...
            throw new \Zend\Json\Server\Exception\RuntimeException ( "Data unavailable: " . $e->getMessage (), \Zend\Json\Server\Error::ERROR_INTERNAL );
        }
