...
namespace Rpc\Greek\Info\Phones;
...
class Phones
{
    ...
    public function lookup($phone)
    {
        if (! is_numeric ( $phone ) || (strlen ( $phone ) !== 10)) {
            throw new \Zend\Json\Exception\InvalidArgumentException ( "Invalid phone: $phone", \Zend\Json\Server\Error::ERROR_INVALID_PARAMS );
        }
        ...
        if (! fil) {
            throw new \Zend\Json\Exception\RuntimeException ( "Data Unavailable", \Zend\Json\Server\Error::ERROR_INTERNAL );
        }
        ...
        if (isset ( $v ) && (! empty ( $v ))) {
            ...
            throw new \Zend\Json\Exception\RuntimeException ( "Lookup Failed", \Zend\Json\Server\Error::ERROR_INTERNAL );
        }
    } // function lookup()
